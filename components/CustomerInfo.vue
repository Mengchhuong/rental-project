        ...
        <div class="container-fluid">
            ...
            <div class="container">
                ...
                <table class="table shadow ">
                    ...
                    <tbody>
                        <tr v-for="item in listCusRent" :key="item">
                        ...
                        <td>{{item.status}}</td>
                        <td>
                            <b-button v-b-modal.modal-5 class="btn btn-light" ><fa icon="edit"/></b-button>
                            ...
                            <b-button v-b-modal.modal-6 class="btn btn-light" ><fa icon="sync"/></b-button>

                            <b-modal id="modal-6" title="Reset Status" ok-title="reset" hide-header-close>
                                <center>
                                    <h3>Are you sure?</h3>
